...
# placing
b1.place(height=20, width=100,x=150,y=100)
b2.place(height=20, width=100,x=290,y=100)
slider.place(height=80, width=150, x=200, y=150)
bar.place(height=20, width=200, x=175, y=230)
percentLabel.place(height=10, width=50, x=250, y=260)
taskLabel.place(height=10, width=200, x=175, y=280)
b3 = Button(app, text='Exit', width=12, command=close)
b3.place(height=20,width=100,x=440,y=300)
# UI design
logo = PhotoImage(file=".\\RESOURCES\\Logo.png")
logo_label = Label(image=logo)
logo_label.place(height=60, width=200,x=175, y=20)
